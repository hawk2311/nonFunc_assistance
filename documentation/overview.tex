...
With the code in "generating.py" it is possible to generate simulated image data that is saved in "sim\_data.h" automatically. Moreover it is not possible to save the output data in a certain file, it is just possible to print it in a console.
