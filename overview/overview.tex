...
All of the code (the main code as well as the following code metioned) is located within the directory "chipyard/tests". Within this directory it is possible
to compile the testfiles for the execution with the following commands.
\begin{verbatim}
    cmake . 

    make 
\end{verbatim}
With the next command it is possible to start the simmlation in "chipyard/sims/verilator": 
\begin{verbatim}
