...
//The following code draws straight lines in the output
...
// //--------------------------------------------------
// // einfache Linienfunktion (Bresenham)
// //--------------------------------------------------
...
//             // Farbe (cyan ähnlich deinem Beispiel)
//             img[i+0] = 0;
//             img[i+1] = 255;
//             img[i+2] = 255;
//         }
...
//     //------------------------------------------------------------------
//     // 3. Flow als Linien zeichnen
//     //------------------------------------------------------------------

//     int step = 10;     // weniger Punkte (wie im Beispielbild) vorher 20
//     float scale = 3.0; // Länge der Linien, vorher 5.0
...
int main()
{
    ...
    for(int y = 0; y < HEIGHT; y += step)
    {
        for(int x = 0; x < WIDTH; x += step)
        {
            ...
            float mag = sqrtf(vx0*vx0 + vy0*vy0);
